...
/// The corner radius for a cornered document frame
/// Default is 32pt.
@property (nonatomic) CGFloat documentFrameCornerSize;

/// The border width for a cornered document frame
/// Default is 4.
@property (nonatomic) CGFloat documentAutocaptureFrameBorderWidth;

/// The corner radius for a cornered document frame
/// Default is 4.
@property (nonatomic) CGFloat documentAutocaptureFrameCornerRadius;

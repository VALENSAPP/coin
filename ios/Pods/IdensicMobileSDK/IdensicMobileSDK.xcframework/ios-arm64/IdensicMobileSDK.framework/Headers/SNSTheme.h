...
/**
 * Matches to `images.pictureWordlessNetworkFailure` by default
 */
@property (nonatomic, nullable) UIImage *sns_OopsScreenWordlessNetworkFailImage
    SNS_THEME_DEPRECATED("Use `images.pictureWordlessNetworkFailure` instead");
/**
 * Matches to `images.pictureWordlessFatalFailure` by default
 */
@property (nonatomic, nullable) UIImage *sns_OopsScreenWordlessFatalFailImage
    SNS_THEME_DEPRECATED("Use `images.pictureWordlessFatalFailure` instead");
/**
 * Matches to `images.iconWordlessRetryButton` by default
 */
@property (nonatomic, nullable) UIImage *sns_OopsScreenWordlessRetryButtonImage
    SNS_THEME_DEPRECATED("Use `images.iconWordlessRetryButton` instead");
/**
 * Matches to `images.iconWordlessGoBackButton` by default
 */
@property (nonatomic, nullable) UIImage *sns_OopsScreenWordlessGoBackButtonImage
    SNS_THEME_DEPRECATED("Use `images.iconWordlessGoBackButton` instead");
 ...
 * Matches to `images.iconDisclosure` by default
 */
@property (nonatomic, nullable) UIImage *sns_DocTypeScreenItemDisclosureImage SNS_THEME_DEPRECATED("Unused");

/**
 * The paddings applied to the item cells at the DocType Selector Screen
 *
 * Default are: 16pt vertically and 12pt horizontally
 */
@property (nonatomic) UIEdgeInsets sns_DocTypeScreenItemPaddings;

/**
 * The paddings applied to the country cell at the DocType Selector Screen
 *
 * Default are: 12pt vertically and 12pt horizontally
 */
@property (nonatomic) UIEdgeInsets sns_DocTypeScreenCountryItemPaddings;

 ...
 *
 * @discussion
 * Use the `strings` dictionary in case you need to define the strings locally.
 *
 * Consider that locale does not affect these strings; thus, it is up to you to use the required localization.
 */

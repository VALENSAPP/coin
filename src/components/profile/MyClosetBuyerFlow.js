              ...
              <View style={styles.heroCard}>
                  ...
                  <View style={styles.identityRow}>
                    ...
                    <View style={styles.identityCopy}>
                      <View style={styles.nameRow}>
                        <Text style={styles.sellerName} numberOfLines={1}>{sellerName} items</Text>
                ...
                <View style={styles.searchRow}>
                  <View style={styles.searchBox}>
                    <Ionicons name="search-outline" size={18} color="#a39bb0" />
                    <TextInput
                      value={search}
                      onChangeText={setSearch}
                      placeholder={t('myClosetBuyer.searchPlaceholder') || 'Search items in my closet...'}
                      placeholderTextColor="#aa9eb8"
                      style={styles.searchInput}
                    />
                  </View>
                  {/* <TouchableOpacity activeOpacity={0.9} style={styles.filterButton}>
                    <Ionicons name="options-outline" size={17} color="#6a4fcf" />
                    <Text style={styles.filterButtonText}>{t('myClosetBuyer.filters') || 'Filters'}</Text>
                  </TouchableOpacity> */}
                </View>
              </View>

              <View style={styles.sectionRow}>
                <Text style={styles.sectionTitle}>{t('myClosetBuyer.categories') || 'Categories'}</Text>
                {/* <TouchableOpacity activeOpacity={0.8}>
                  <View style={styles.viewAllText}>
                    <Text style={{ color: accent, fontSize: 12, fontWeight: '800' }}>
                      {t('myClosetBuyer.viewAll') || 'View all'}
                    </Text>
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    <View style={[styles.categoryIconWrap, selectedCategory === item.key && { backgroundColor: `${accent}18` }]}>
                      <Ionicons name={item.icon} size={18} color={selectedCategory === item.key ? accent : '#6b6281'} />
                    </View>
              ...
              <View style={styles.sortRow}>
                ...
                >
                  <Text style={styles.sortLabel}>
                    {t('myClosetBuyer.sortBy') || 'Sort by:'} <Text style={styles.sortValue}>{sortKey === 'newest' ? (t('myClosetBuyer.newest') || 'Newest') : sortKey === 'price_low' ? 'Price: Low' : 'Price: High'}</Text>
                  </Text>
                  <Ionicons name="chevron-down" size={14} color="#746b85" />
                </TouchableOpacity>
                <View style={styles.viewToggle}>
                  ...
                  {/* <View style={styles.toggleButton}>
                    <Ionicons name="list" size={15} color="#8a8297" />
                  </View> */}
                </View>
              </View>
            </View>
...
const BuyerItemCard = ({ item, accent, t, onPress, onToggleWishlist, sellerId, text }) => {
